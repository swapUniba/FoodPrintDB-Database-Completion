...
create or replace view covered_recipes as
select *  from (
...
case
when static_score >= 0.35 then 'LOW'
WHEN static_score > 0.15 AND static_score< 0.35 THEN 'MEDIUM'
WHEN static_score < 0.15  THEN 'HIGH'
END SUSTAINABILITY
